...
import 'package:cytex/dev/header/diagonally_cut_colored_image.dart';

class FriendDetailHeader extends StatelessWidget {
  static const BACKGROUND_IMAGE = CytexConstants.BACKGROUND_IMAGE;
  ...
  Widget _buildAvatar() {
    return new Hero(
      ...
      child: new CircleAvatar(
        backgroundImage: new AssetImage(CytexConstants.DEV_WEB),
        radius: 50.0,
      ),
    );
  }
