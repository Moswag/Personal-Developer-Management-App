...
import 'add_technology.dart';


class ViewTechnologies extends StatefulWidget {
  ViewTechnologies({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewTechnologiesState();
}

class _ViewTechnologiesState extends State<ViewTechnologies> {
  @override
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (BuildContext ctx) => AddTechnology()));
              },
            )
          ],
        ),
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: Firestore.instance
                    .collection(DBConstants.TABLE_TECHNOLOGIES)
                    .snapshots(),
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          ...
          String numberOfUse = document[positon].data['numberOfUse'].toString();
          ...
          return Card(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(' '+ description +'\n Number Of Types Used: '+numberOfUse+'\n Date: ' + date,
                      style: TextStyle(
