...
class ViewProjects extends StatefulWidget {
  ViewProjects({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewProjectsState();
}
        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx)=>SignInScreen()));
              },
            ),
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx)=>AddProject()));
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: Firestore.instance
                    .collection(DBConstants.TABLE_PROJECTS)
                    .snapshots(),
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(CytexConstants.BACKGROUND_IMAGE), fit: BoxFit.cover),
                    boxShadow: [
    ...
    ListView getNoteListView(){
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon){
          ...
          String startDate = document[positon].data['startDate'].toString();
          String endDate = document[positon].data['endDate'].toString();
          ...
          return Card(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(' Starting '+startDate+'\n ending '+endDate +'\n Status: '+status, style: TextStyle(
                      color: Colors.white, fontWeight: FontWeight.normal)),

                  trailing: GestureDetector(   //to make the icon clickable and respond
