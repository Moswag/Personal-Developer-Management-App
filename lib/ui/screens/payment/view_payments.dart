...
class ViewPayments extends StatefulWidget {
  ViewPayments({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewPaymentsState();
}
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: Firestore.instance
                    .collection(DBConstants.TABLE_PAYMENTS)
                    .snapshots(),
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          String client = document[positon].data['client'].toString();
          String nature = document[positon].data['nature'].toString();
                  ...
                  trailing: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      Scaffold.of(context).showSnackBar(
                          new SnackBar(content: new Text('Payment Deleted')));
                    },
                  ),
                  onTap: () {
