...
import 'add_disturbance.dart';

class ViewDisturbances extends StatefulWidget {
  ViewDisturbances({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewDisturbancesState();
}

class _ViewDisturbancesState extends State<ViewDisturbances> {
  @override
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (BuildContext ctx) => AddDisturbance()));
              },
            )
          ],
        ),
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: Firestore.instance
                    .collection(DBConstants.TABLE_DISTURBANCES)
                    .snapshots(),
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          ...
          String startingTime =
              document[positon].data['startTime'].toString();
          String timeStoped = document[positon].data['timeClosed'].toString();
