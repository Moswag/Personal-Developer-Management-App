...
class AddQuestion extends StatefulWidget {
  AddQuestion({this.email});
  final String email;

  @override
  State createState() => _AddQuestionState();
}
...
class _AddQuestionState extends State<AddQuestion> {
  ...
  Future _addQuestion({Question question}) async {
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        question.status=CytexConstants.QUESTION_NOT_ANSWERED;


        MyService.addQuestion(question).then((onValue) {
          if (onValue) {
            AlertDiag.showAlertDialog(context, 'Status',
                'Question Successfully Added', MyRoutes.VIEW_QUESTIONS);
          } else {
            AlertDiag.showAlertDialog(
                context,
                'Status',
                'Failed to add Question, please contact developer',
