...
class ViewQuestions extends StatefulWidget {
  ViewQuestions({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewQuestionsState();
}
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (BuildContext ctx) => AddQuestion()));
              },
            )
          ],
        ),
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: Firestore.instance
                    .collection(DBConstants.TABLE_QUESTIONS)
                    .snapshots(),
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          ...
          question.question = document[positon].data['question'].toString();
          question.status = document[positon].data['status'].toString();
          question.date = document[positon].data['date'].toString();
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context)=>new EditQuestion(
                          question: question,
